...
$(document).keypress(function (e) {
    ...
    j++;
    eventCount++;
    // sets initial div#yellow-block position
    $('#yellow-block').css('left', '+=16.4')
    // game NOT over condition
    if (eventCount < totalChars) {
        // condition for when last character of current sentence is reached
        ...
        // checks if player input is correct or wrong
...
//click listeners for Replay or do Nothing
